...
for feat in cat_feats:
    if df[feat].nunique() > 2:
        ...
        len_embed_feats.append(len(df[feat].nunique()))
        print(feat + ': {} values'.format(len(df[feat].nunique())))
print('Number of embed features :', len(embed_feats))
...
folds = StratifiedKFold(n_splits=kfold_splits, shuffle=True, random_state=42)
